...
public class NodeVersionTest {
  ...
  public void serializesToJSON() throws Exception {
    ...
    final String expected = convertFromClassToString(convertFromStringToClass(readFromFile
        ("test/resources/fixtures/models/node_version.json"), NodeVersion.class));
    assertThat(convertFromClassToString(nodeVersion)).isEqualTo(expected);
  }
  ...
  public void deserializesFromJSON() throws Exception {
    ...
    assertEquals(convertFromStringToClass(
        readFromFile("test/resources/fixtures/models/node_version.json"),
