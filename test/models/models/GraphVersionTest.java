...
public class GraphVersionTest {
  ...
  public void serializesToJSON() throws Exception {
    ...
    GraphVersion graphVersion = new GraphVersion(1, tagsMap, -1, "http://www.google.com", parametersMap, 1, graphVersionIds);

    final String expected = convertFromClassToString(convertFromStringToClass(readFromFile
        ("test/resources/fixtures/models/graph_version.json"), GraphVersion.class));
    assertThat(convertFromClassToString(graphVersion)).isEqualTo(expected);
  }
  ...
  public void deserializesFromJSON() throws Exception {
    ...
    assertEquals(convertFromStringToClass(
        readFromFile("test/resources/fixtures/models/graph_version.json"),
