...
public class EdgeVersionTest {
  ...
  public void serializesToJSON() throws Exception {
    ...
    final String expected = convertFromClassToString(convertFromStringToClass(readFromFile
        ("test/resources/fixtures/models/edge_version.json"), EdgeVersion.class));
    assertThat(convertFromClassToString(edgeVersion)).isEqualTo(expected);
  }
  ...
  public void deserializesFromJSON() throws Exception {
    ...
    assertEquals(convertFromStringToClass(
        readFromFile("test/resources/fixtures/models/edge_version.json"),
        EdgeVersion.class), edgeVersion);
  }
