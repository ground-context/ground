...
public class LineageGraphVersionTest {
  ...
  public void serializesToJSON() throws Exception {
    ...
    assertThat(convertFromClassToString(lineageGraphVersion)).isEqualTo(expected);
  }
  ...
  public void testLineageGraphVersionNotEquals() throws Exception {
    ...
    LineageGraphVersion differenLineageGraphVersionId = new LineageGraphVersion(1, new HashMap<>(), 10,
        "http://www.google.com", new HashMap<>(), 3, new ArrayList<>());
