...
public class CassandraLineageGraphVersionFactoryTest extends CassandraTest {
  ...
  public void testLineageGraphVersionCreation() throws GroundException {
    ...
    long lineageGraphVersionId = CassandraTest.lineageGraphVersionFactory
        .create(tags, structureVersionId, testReference, parameters, lineageGraphId,
            lineageEdgeVersionIds, new ArrayList<>()).getId();

    LineageGraphVersion retrieved = CassandraTest.lineageGraphVersionFactory
  ...
  public void testBadLineageGraphVersion() throws GroundException {
    ...
    try {
      CassandraTest.lineageGraphVersionFactory.retrieveFromDatabase(id);
