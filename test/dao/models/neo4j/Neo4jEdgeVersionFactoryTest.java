...
public class Neo4jEdgeVersionFactoryTest extends Neo4jTest {
  ...
  public void testEdgeVersionCreation() throws GroundException {
    try {
      ...
      long edgeVersionId = Neo4jTest.edgeVersionFactory.create(tags, structureVersionId,
          testReference, parameters, edgeId, firstNodeVersionId, -1, secondNodeVersionId, -1,
          new ArrayList<>()).getId();

      EdgeVersion retrieved = Neo4jTest.edgeVersionFactory.retrieveFromDatabase(edgeVersionId);
  ...
  public void testCorrectEndVersion() throws GroundException {
    try {
      ...
      EdgeVersion parent = Neo4jTest.edgeVersionFactory.retrieveFromDatabase(edgeVersionId);
      EdgeVersion child = Neo4jTest.edgeVersionFactory.retrieveFromDatabase(newEdgeVersionId);
  ...
  public void testBadEdgeVersion() throws GroundException {
    ...
    try {
      Neo4jTest.edgeVersionFactory.retrieveFromDatabase(id);
