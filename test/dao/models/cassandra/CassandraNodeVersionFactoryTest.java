...
public class CassandraNodeVersionFactoryTest extends CassandraTest {
  ...
  public void testNodeVersionCreation() throws GroundException {
    ...
    long nodeVersionId = CassandraTest.nodeVersionFactory.create(tags, structureVersionId,
        testReference, parameters, nodeId, new ArrayList<>()).getId();

    NodeVersion retrieved = CassandraTest.nodeVersionFactory.retrieveFromDatabase(nodeVersionId);
    ...
    List<Long> leaves = CassandraTest.nodeFactory.getLeaves(nodeName);
  ...
  public void testBadNodeVersion() throws GroundException {
    ...
    try {
      CassandraTest.nodeVersionFactory.retrieveFromDatabase(id);
