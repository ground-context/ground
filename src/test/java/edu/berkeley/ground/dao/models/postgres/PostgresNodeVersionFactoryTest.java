...
public class PostgresNodeVersionFactoryTest extends PostgresTest {
  ...
  public void testNodeVersionCreation() throws GroundException {
    ...
    long nodeVersionId = PostgresTest.nodesResource.createNodeVersion(nodeId, tags, parameters,
        structureVersionId, testReference, new ArrayList<>()).getId();

    NodeVersion retrieved = PostgresTest.nodesResource.getNodeVersion(nodeVersionId);
  ...
  public void testBadNodeVersion() throws GroundException {
    ...
    try {
      PostgresTest.nodesResource.getNodeVersion(id);
