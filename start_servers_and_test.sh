...
cd ground/ground-core/scripts/postgres && python2.7 postgres_setup.py test test && cd ../../../..
cd ground/ground-core/scripts/cassandra && python2.7 cassandra_setup.py test && cd ../../../..

# run tests
cd ground && mvn clean test
