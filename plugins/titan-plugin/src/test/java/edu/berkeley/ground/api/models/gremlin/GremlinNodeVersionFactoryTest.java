...
public class GremlinNodeVersionFactoryTest extends GremlinTest {

    public GremlinNodeVersionFactoryTest() throws GroundException {
        super();
    }

    @Test
    public void testNodeVersionCreation() {
        try {
