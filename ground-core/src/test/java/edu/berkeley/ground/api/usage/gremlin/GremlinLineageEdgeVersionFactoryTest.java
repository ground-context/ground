...
public class GremlinLineageEdgeVersionFactoryTest extends GremlinTest {

    public GremlinLineageEdgeVersionFactoryTest() throws GroundException {
        super();
    }

    @Test
    public void testLineageEdgeVersionCreation() {
        try {
            ...
            String lineageEdgeVersionId = super.factories.getLineageEdgeVersionFactory().create(tags,
                    structureVersionId, testReference, parameters, lineageEdgeId, firstNodeVersionId,
