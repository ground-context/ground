...
public class HeadCommit {
     ...
     * @param distinct
     */
    public HeadCommit(String id, String treeId, Boolean distinct, String message, String timestamp, String url, Author author, Committer committer, List<Object> added, List<Object> removed, List<String> modified) {
        this.id = id;
        this.treeId = treeId;
