...
public interface GraphVersionFactory extends RichVersionFactory<GraphVersion> {
    GraphVersion create(Map<String, Tag> tags, long structureVersionId, String reference,
	    Map<String, String> referenceParameters, long graphId, List<Long> edgeVersionIds, List<Long> parentIds)
