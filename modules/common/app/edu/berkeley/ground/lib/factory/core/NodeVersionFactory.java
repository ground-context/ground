...
public interface NodeVersionFactory extends RichVersionFactory<NodeVersion> {
    NodeVersion create(Map<String, Tag> tags, long structureVersionId, String reference,
	    Map<String, String> referenceParameters, long nodeId, List<Long> parentIds) throws GroundException;
