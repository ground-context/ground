...
public interface VersionHistoryDagFactory {
     ...
     *            the child's id
     * @param itemId
     *            the id of the Item whose DAG we're updating
     */
    void addEdge(VersionHistoryDag dag, long parentId, long childId, long itemId) throws GroundException;

    /**
     * Truncate the DAG to only have a certain number of levels, removing
     * everything before that.
     *
     * TODO: Once we have delta-encoded tags, this should also update the
     * associated tags.
     *
     * @param dag
     *            the DAG to truncate
     * @param numLevels
     *            the number of levels to keep
     */
