...
public interface ItemFactory<T extends Item> {
    ...
    /**
     * Add a new Version to this Item. The provided parentIds will be the parents of this particular version. What's provided in
     * the default case varies based on which database we are writing into.
     *
     * @param itemId
     *            the id of the Item we're updating
     * @param childId
     *            the new version's id
     * @param parentIds
     *            the ids of the parents of the child
     */
     ...
     *             an error while removing versions
     */
