...
public class GraphVersion extends RichVersion {
   ...
   *
   * @param id
   *          the id of this graph version
   * @param tags
   *          the tags associated with this graph version
   * @param structureVersionId
   *          the id of the StructureVersion associated with this graph version
   * @param reference
   *          an optional external reference
   * @param referenceParameters
   *          the access parameters of the reference
   * @param graphId
   *          the id of the graph containing this version
   * @param edgeVersionIds
   *          the list of edge versions in this graph version
   */

  public GraphVersion(long id, Map<String, Tag> tags, long structureVersionId, String reference,
      Map<String, String> referenceParameters, long graphId, List<Long> edgeVersionIds) {
  ...
  public boolean equals(Object other) {
    ...
    return this.graphId == otherGraphVersion.graphId
        && this.edgeVersionIds.equals(otherGraphVersion.edgeVersionIds) && super.equals(other);
  }
}
