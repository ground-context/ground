...
public class LineageGraph extends Item<LineageGraphVersion> {
   ...
   *
   * @param id
   *          the id of lineage graph
   * @param name
   *          the name of the lineage graph
   * @param sourceKey
   *          the user-generated unique key for the graph
   * @param tags
  ...
  public boolean equals(Object other) {
    ...
    return this.name.equals(otherLineageGraph.name) && this.getId() == otherLineageGraph.getId()
