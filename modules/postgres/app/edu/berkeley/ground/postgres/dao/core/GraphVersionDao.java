...
public class GraphVersionDao extends RichVersionDao<GraphVersion> implements GraphVersionFactory {
  ...
  public GraphVersion create(final GraphVersion graphVersion, List<Long> parentIds)
    ...
    PostgresStatements updateVersionList = new PostgresStatements(itemDao.update(newGraphVersion.getGraphId(), newGraphVersion.getId(), parentIds));
  ...
  @Override
  public GraphVersion retrieveFromDatabase(Database dbSource, long id) throws GroundException {
