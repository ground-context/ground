...
public class SqlConstants {
  ...
  public static final String SELECT_STAR_ITEM_BY_ID = "SELECT * FROM %s WHERE id = %d;";
  ...
  public static final String SELECT_VERSION_SUCCESSOR_BY_ENDPOINT = "SELECT * FROM version_sucessor WHERE to_version_id = %d;";
  ...
  public static final String INSERT_ITEM_TAG_WITH_VALUE = "INSERT INTO item_tag (rich_version_id, key, value, type) VALUES (%d, " + "\'%s\', \'%s\', "
                                                            + "\'%s\');";
  public static final String INSERT_ITEM_TAG_NO_VALUE = "INSERT INTO item_tag (rich_version_id, key, value, type) VALUES (%d, " + "\'%s\', null, "
                                                          + "null);";

  /* Edge-specific statements */
  public static final String INSERT_EDGE = "INSERT INTO edge (item_id, source_key, from_node_id, to_node_id, name) ) VALUES (%d, \'%s\', %d, %d, "
                                             + "\'%s\'";
  ...
  public static final String INSERT_STRUCTURE_VERSION = "INSERT INTO structure_version (id, structure_id) VALUE (%d, %d);";
  ...
  public static final String DELETE_STRUCTURE_VERSION_ATTRIBUTES = "DELETE FROM structure_version_attributes WHERE structure_version_id = %d";
