...
public class ItemDaoTest extends PostgresTest {
  ...
  public void testCorrectUpdateWithLinearHistory() throws GroundException {
    ...
    PostgresUtils
      .executeSqlList(dbSource, PostgresTest.itemDao.update(testId, fromId, parentIds));
  ...
  public void testMultipleParents() throws GroundException {
    ...
    PostgresUtils
      .executeSqlList(dbSource, PostgresTest.itemDao.update(testId, parentOne, parentIds));
    PostgresUtils
      .executeSqlList(dbSource, PostgresTest.itemDao.update(testId, parentTwo, parentIds));
