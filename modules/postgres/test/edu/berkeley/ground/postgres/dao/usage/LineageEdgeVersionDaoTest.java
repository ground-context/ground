...
public class LineageEdgeVersionDaoTest extends PostgresTest {

  public LineageEdgeVersionDaoTest() throws GroundException {
    super();
  }
  ...
  public void testLineageEdgeVersionCreation() throws GroundException {
    try {
      ...
      LineageEdgeVersion lineageEdgeVersion = new LineageEdgeVersion(0L, tags, structureVersionId, testReference, parameters, firstNodeVersionId,
        secondNodeVersionId, lineageEdgeId);

      long lineageEdgeVersionId = PostgresTest.lineageEdgeVersionDao.create(lineageEdgeVersion, new ArrayList<>()).getId();
