...
public class CassandraGraphVersionDaoTest extends CassandraTest {

  public CassandraGraphVersionDaoTest() throws GroundException {
    super();
  }
  ...
  public void testGraphVersionCreation() throws GroundException {
    ...
    long graphVersionId = CassandraTest.graphVersionDao.create(graphVersion, new ArrayList<>()).getId();

    GraphVersion retrieved = CassandraTest.graphVersionDao.retrieveFromDatabase(graphVersionId);
  ...
  public void testCreateEmptyGraph() throws GroundException {
    ...
    long graphVersionId = CassandraTest.graphVersionDao.create(graphVersion, new ArrayList<>())
                            .getId();

    GraphVersion retrieved = CassandraTest.graphVersionDao
  ...
  public void testBadGraphVersion() throws GroundException {
    ...
    try {
      CassandraTest.graphVersionDao.retrieveFromDatabase(id);
