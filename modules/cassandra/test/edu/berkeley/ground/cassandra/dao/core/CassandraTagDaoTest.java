...
public class CassandraTagDaoTest extends CassandraTest {

  public CassandraTagDaoTest() throws GroundException {
    super();
  }
  ...
  public void testGetItemIdsByTag() throws GroundException {
    ...
    long nodeId1 = CassandraTest.nodeDao.create(new Node(0L, null, "test1", tagsMap)).getId();
    long nodeId2 = CassandraTest.nodeDao.create(new Node(0L, null, "test2", tagsMap)).getId();

    List<Long> ids = CassandraTest.tagDao.getItemIdsByTag("testtag");
  ...
  public void testGetVersionIdsByTag() throws GroundException {
    ...
    long nodeVersionId1 = CassandraTest.nodeVersionDao.create(nodeVersion1, new ArrayList<>())
                            .getId();
    NodeVersion nodeVersion2 = new NodeVersion(0L, tagsMap, -1, null, new HashMap<>(), nodeId);
    long nodeVersionId2 = CassandraTest.nodeVersionDao.create(nodeVersion2, new ArrayList<>())
                            .getId();

    List<Long> ids = CassandraTest.tagDao.getVersionIdsByTag("testtag");
