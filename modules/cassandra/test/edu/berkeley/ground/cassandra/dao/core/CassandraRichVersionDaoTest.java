...
public class CassandraRichVersionDaoTest extends CassandraTest {

  public CassandraRichVersionDaoTest() throws GroundException {
    super();
  }
  ...
  public void testReference() throws GroundException {
    ...
    RichVersion richVersion = new RichVersion(id, new HashMap<String, Tag>(), -1L, testReference,
                                               parameters);
    CassandraTest.cassandraRichVersionDao.create(richVersion, new ArrayList<>());

    RichVersion retrieved = CassandraTest.cassandraRichVersionDao.retrieveFromDatabase(id);
