...
public class CassandraStructureVersionDaoTest extends CassandraTest {

  public CassandraStructureVersionDaoTest() throws GroundException {
    super();
  }
  ...
  public void testStructureVersionCreation() throws GroundException {
    ...
    long structureVersionId = CassandraTest.structureVersionDao
                                .create(structureVersion, new ArrayList<>()).getId();

    StructureVersion retrieved = CassandraTest.structureVersionDao
  ...
  public void testBadStructureVersion() throws GroundException {
    ...
    try {
      CassandraTest.structureVersionDao.retrieveFromDatabase(id);
