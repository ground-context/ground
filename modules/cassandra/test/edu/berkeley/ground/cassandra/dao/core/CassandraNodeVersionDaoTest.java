...
public class CassandraNodeVersionDaoTest extends CassandraTest {

  public CassandraNodeVersionDaoTest() throws GroundException {
    super();
  }
  ...
  public void testNodeVersionCreation() throws GroundException {
    ...
    long nodeVersionId = CassandraTest.nodeVersionDao.create(nodeVersion, new ArrayList<>()).getId();

    NodeVersion retrieved = CassandraTest.nodeVersionDao.retrieveFromDatabase(nodeVersionId);
    ...
    List<Long> leaves = CassandraTest.nodeDao.getLeaves(nodeName);
  ...
  public void testBadNodeVersion() throws GroundException {
    ...
    try {
      CassandraTest.nodeVersionDao.retrieveFromDatabase(id);
