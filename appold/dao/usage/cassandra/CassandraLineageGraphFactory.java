...
public class CassandraLineageGraphFactory extends CassandraItemFactory<LineageGraph>
   ...
   */
  public CassandraLineageGraphFactory(
  ...
  private LineageGraph retrieveByPredicate(String fieldName, Object value, GroundType valueType)
    ...
    CassandraResults resultSet =
        this.dbClient.equalitySelect("lineage_graph", DbClient.SELECT_STAR, predicates);
