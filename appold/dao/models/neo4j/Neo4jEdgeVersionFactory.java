...
public class Neo4jEdgeVersionFactory extends Neo4jRichVersionFactory<EdgeVersion>
   ...
   */
  public Neo4jEdgeVersionFactory(
  ...
  public EdgeVersion retrieveFromDatabase(long id) throws GroundException {
    ...
    long fromNodeVersionStartId =
        versionRecord.get("v").asNode().get("from_node_start_id").asLong();
    long fromNodeVersionEndId = versionRecord.get("v").asNode().get("from_node_end_id").asLong();
    long toNodeVersionStartId = versionRecord.get("v").asNode().get("to_node_start_id").asLong();
    long toNodeVersionEndId = versionRecord.get("v").asNode().get("to_node_end_id").asLong();
