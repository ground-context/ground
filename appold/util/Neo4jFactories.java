...
public class Neo4jFactories implements FactoryGenerator {
  ...
  public Neo4jFactories(Configuration configuration) throws GroundDbException {
    ...
    this.neo4jClient =
        new Neo4jClient(
            dbConf.getString("host"), dbConf.getString("user"), dbConf.getString("password"));
    ...
    this.structureFactory =
        new Neo4jStructureFactory(
            this.neo4jClient, versionHistoryDagFactory, tagFactory, idGenerator);
    this.structureVersionFactory =
        new Neo4jStructureVersionFactory(this.neo4jClient, this.structureFactory, idGenerator);
    this.edgeFactory =
        new Neo4jEdgeFactory(this.neo4jClient, versionHistoryDagFactory, tagFactory, idGenerator);
    this.edgeVersionFactory =
        new Neo4jEdgeVersionFactory(
            this.neo4jClient,
            this.edgeFactory,
            this.structureVersionFactory,
            tagFactory,
    ...
    this.graphFactory =
        new Neo4jGraphFactory(this.neo4jClient, versionHistoryDagFactory, tagFactory, idGenerator);
    this.graphVersionFactory =
        new Neo4jGraphVersionFactory(
            this.neo4jClient,
            this.graphFactory,
            this.structureVersionFactory,
            tagFactory,
            idGenerator);
    this.nodeFactory =
        new Neo4jNodeFactory(this.neo4jClient, versionHistoryDagFactory, tagFactory, idGenerator);
    this.nodeVersionFactory =
        new Neo4jNodeVersionFactory(
            this.neo4jClient,
            this.nodeFactory,
            this.structureVersionFactory,
            tagFactory,
    ...
    this.lineageEdgeFactory =
        new Neo4jLineageEdgeFactory(
            this.neo4jClient, versionHistoryDagFactory, tagFactory, idGenerator);
    this.lineageEdgeVersionFactory =
        new Neo4jLineageEdgeVersionFactory(
            this.neo4jClient,
            this.lineageEdgeFactory,
    ...
    this.lineageGraphFactory =
        new Neo4jLineageGraphFactory(
            this.neo4jClient, versionHistoryDagFactory, tagFactory, idGenerator);
    this.lineageGraphVersionFactory =
        new Neo4jLineageGraphVersionFactory(
            this.neo4jClient,
            this.lineageGraphFactory,
            this.structureVersionFactory,
            tagFactory,
