...
public class CassandraFactories implements FactoryGenerator {
  ...
  public CassandraFactories(Configuration configuration) throws GroundDbException {
    ...
    this.structureFactory =
        new CassandraStructureFactory(
            cassandraClient, versionHistoryDagFactory, tagFactory, idGenerator);
    this.structureVersionFactory =
        new CassandraStructureVersionFactory(cassandraClient, this.structureFactory, idGenerator);
    this.edgeFactory =
        new CassandraEdgeFactory(
            cassandraClient, versionHistoryDagFactory, tagFactory, idGenerator);
    this.edgeVersionFactory =
        new CassandraEdgeVersionFactory(
            cassandraClient,
            this.edgeFactory,
            this.structureVersionFactory,
            tagFactory,
    ...
    this.graphFactory =
        new CassandraGraphFactory(
            cassandraClient, versionHistoryDagFactory, tagFactory, idGenerator);
    this.graphVersionFactory =
        new CassandraGraphVersionFactory(
            cassandraClient,
            this.graphFactory,
            this.structureVersionFactory,
            tagFactory,
            idGenerator);
    this.nodeFactory =
        new CassandraNodeFactory(
            cassandraClient, versionHistoryDagFactory, tagFactory, idGenerator);
    this.nodeVersionFactory =
        new CassandraNodeVersionFactory(
            cassandraClient,
            this.nodeFactory,
            this.structureVersionFactory,
            tagFactory,
    ...
    this.lineageEdgeFactory =
        new CassandraLineageEdgeFactory(
            cassandraClient, versionHistoryDagFactory, tagFactory, idGenerator);
    this.lineageEdgeVersionFactory =
        new CassandraLineageEdgeVersionFactory(
            cassandraClient,
            this.lineageEdgeFactory,
    ...
    this.lineageGraphFactory =
        new CassandraLineageGraphFactory(
            cassandraClient, versionHistoryDagFactory, tagFactory, idGenerator);
    this.lineageGraphVersionFactory =
        new CassandraLineageGraphVersionFactory(
            cassandraClient,
            this.lineageGraphFactory,
            this.structureVersionFactory,
            tagFactory,
