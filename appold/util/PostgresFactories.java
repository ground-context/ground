...
public class PostgresFactories implements FactoryGenerator {
  ...
  public PostgresFactories(Configuration configuration) throws GroundDbException {
    ...
    this.structureFactory =
        new PostgresStructureFactory(
            this.postgresClient, versionHistoryDagFactory, tagFactory, idGenerator);
    this.structureVersionFactory =
        new PostgresStructureVersionFactory(
            this.postgresClient, this.structureFactory, idGenerator);
    this.edgeFactory =
        new PostgresEdgeFactory(
            this.postgresClient, versionHistoryDagFactory, tagFactory, idGenerator);
    this.edgeVersionFactory =
        new PostgresEdgeVersionFactory(
            this.postgresClient,
            this.edgeFactory,
            this.structureVersionFactory,
            tagFactory,
    ...
    this.graphFactory =
        new PostgresGraphFactory(
            this.postgresClient, versionHistoryDagFactory, tagFactory, idGenerator);
    this.graphVersionFactory =
        new PostgresGraphVersionFactory(
            this.postgresClient,
            this.graphFactory,
            this.structureVersionFactory,
            tagFactory,
            idGenerator);
    this.nodeFactory =
        new PostgresNodeFactory(
            this.postgresClient, versionHistoryDagFactory, tagFactory, idGenerator);
    this.nodeVersionFactory =
        new PostgresNodeVersionFactory(
            this.postgresClient,
            this.nodeFactory,
            this.structureVersionFactory,
            tagFactory,
    ...
    this.lineageEdgeFactory =
        new PostgresLineageEdgeFactory(
            this.postgresClient, versionHistoryDagFactory, tagFactory, idGenerator);
    this.lineageEdgeVersionFactory =
        new PostgresLineageEdgeVersionFactory(
            this.postgresClient,
            this.lineageEdgeFactory,
    ...
    this.lineageGraphFactory =
        new PostgresLineageGraphFactory(
            this.postgresClient, versionHistoryDagFactory, tagFactory, idGenerator);
    this.lineageGraphVersionFactory =
        new PostgresLineageGraphVersionFactory(
            this.postgresClient,
            this.lineageGraphFactory,
            this.structureVersionFactory,
            tagFactory,
