...
public class EdgeVersion extends RichVersion {
  ...
  public EdgeVersion(
      ...
      ("edgeId") long edgeId,
      ("fromNodeVersionStartId") long fromNodeVersionStartId,
      ("fromNodeVersionEndId") long fromNodeVersionEndId,
      ("toNodeVersionStartId") long toNodeVersionStartId,
      ("toNodeVersionEndId") long toNodeVersionEndId) {
